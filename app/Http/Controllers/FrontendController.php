...
class FrontendController extends Controller
{
    public function index()
    {
      ...
      return view('frontend.index', compact('sliders','sections', 'company'));
    }

    public function about()
    {
        $banner = Banner::firstOrCreate(['page' => 'About']);
        $about = Master::firstOrCreate(['name' => 'contact']);
        $this->seo(
            $about->meta_title,
            $about->meta_description,
            $about->meta_keywords,
            $about->meta_image ? asset('images/products/meta/' . $about->meta_image) : null
        );
    ...
    {      
          ...
          return view('frontend.services', compact('banner'));    
    }
    ...
    {
      $banner = Banner::firstOrCreate(['page' => 'Contact']);
    ...
    public function storeContact(Request $request)
    {
        ...
        $contact = new Contact();
        $contact->fill($request->only('name', 'email', 'phone', 'company', 'message'))->save();

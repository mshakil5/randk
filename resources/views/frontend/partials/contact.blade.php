<section id="contact" class="contact section light-background">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="contact-main-wrapper">
            ...
            <div class="left-wrapper d-flex flex-column gap-4">
                ...
                <div class="contact-form-container mb-3" data-aos="fade-up" data-aos-delay="200">
                    <h4 class="mb-2">Areas We Serve!</h4>
                    <p class="mb-3">We cover many areas around Yorkshire.</p>

                    <div class="row g-3">
                        @foreach (['Huddersfield', 'Dewsbury', 'Bradford', 'Wakefield', 'Leeds', 'Manchester', 'Liverpool', 'Hull'] as $area)
                            <div class="col-6">
                                <div class="contact-card d-flex align-items-center">
                                    <div class="icon-box">
                                        <i class="bi bi-pin-map-fill"></i>
                                    </div>
                                    <div class="contact-text ms-2">
                                        <p class="mb-0">{{ $area }}</p>
                                    </div>
                                </div>
                            </div>

            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-content text-center">
                    <a href="{{ route('home') }}" class="logo d-flex align-items-center justify-content-center">
                        ...
                        <h1 class="sitename mb-0" style="font-size: 22px; color: #1d2554;">
                ...
                <div class="footer-contact">
                    ...
                    @if ($company->whatsapp)
                        <div class="contact-item">
                            ...
                            <div class="contact-info">
                                <p><a href="https://wa.me/{{ $company->whatsapp }}" target="_blank">Chat on
                                        WhatsApp</a></p>
                            </div>
                        </div>
                    @endif
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="footer-bottom-links">
                        <a class="d-none" href="{{ route('privacy-policy') }}">Privacy Policy</a>
                        <a class="d-none" href="{{ route('terms-and-conditions') }}">Terms of Service</a>
                    </div>
                    <div class="credits">
